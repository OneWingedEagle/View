...
public class  VectField extends TransformGroup{
	...
	public VectField(Model model, ColorBar cBar,int[] surfVertNumbs,int nr,int mode,int vectMode){
	...
	public VectField(Model model,ColorBar cBar, int nr,int mode,int vectMode)
	{
